...
/**
 * This is the extension manager of the Ebookb2bcommerceservices extension.
 */
public class Ebookb2bcommerceservicesManager extends GeneratedEbookb2bcommerceservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Ebookb2bcommerceservicesManager.class.getName());
	 ...
	 */
	public static Ebookb2bcommerceservicesManager getInstance()
	{
		return (Ebookb2bcommerceservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Ebookb2bcommerceservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Ebookb2bcommerceservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Ebookb2bcommerceservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Ebookb2bcommerceservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Ebookb2bcommerceservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
