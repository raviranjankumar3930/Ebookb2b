 ...
 *  
 */
package com.ebookb2b.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(Ebookb2bFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(Ebookb2bFulfilmentProcessConstants.PARENT_PROCESS);
