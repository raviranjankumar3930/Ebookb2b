 ...
 *  
 */
package com.ebookb2b.test.setup;
...
import com.ebookb2b.test.constants.Ebookb2bTestConstants;
import com.ebookb2b.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = Ebookb2bTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/ebookb2btest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/ebookb2btest/import/reviews.impex");
			...
			importImpexFile(context, "/ebookb2btest/import/cstickets.impex");
		}
	}
}
