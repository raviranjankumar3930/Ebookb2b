 ...
 *  
 */
package com.ebookb2b.cockpits.setup;
...
import com.ebookb2b.cockpits.constants.Ebookb2bCockpitsConstants;
 ...
 */
@SystemSetup(extension = Ebookb2bCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(Ebookb2bCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(Ebookb2bCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						Ebookb2bCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/ebookb2bcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
