...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performCreateTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createItemType(
			"ApparelProduct",
			"Product",
			com.ebookb2b.core.jalo.ApparelProduct.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"VariantProduct",
			com.ebookb2b.core.jalo.ApparelStyleVariantProduct.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"ApparelStyleVariantProduct",
			com.ebookb2b.core.jalo.ApparelSizeVariantProduct.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"VariantProduct",
			com.ebookb2b.core.jalo.ElectronicsColorVariantProduct.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"VariantProduct",
			com.ebookb2b.core.jalo.EbookSizeVariantProduct.class,
			null,
			false,
			null,
			false
	...
	protected final void performModifyTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performModifyTypes
				...
				single_createattr_EbookSizeVariantProduct_bookSize();
	...
	public void single_createattr_EbookSizeVariantProduct_bookSize() throws JaloBusinessException
	{
	...
	protected final void performCreateObjects( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createEnumerationValues(
			...
			single_setAttributeProperties_EbookSizeVariantProduct_bookSize();
			...
			single_setAttributeProperties_Customer_isInternal();
				...
				setDefaultProperties(
					...
					null
						...
						public void single_setAttributeProperties_EbookSizeVariantProduct_bookSize() throws JaloBusinessException
						{
