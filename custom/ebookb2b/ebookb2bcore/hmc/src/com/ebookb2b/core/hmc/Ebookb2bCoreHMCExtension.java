...
/**
 * Provides necessary meta information about the ebookb2bcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class Ebookb2bCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(Ebookb2bCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.ebookb2b.core.hmc.locales";
