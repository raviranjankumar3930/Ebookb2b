...
import com.ebookb2b.storefront.controllers.ControllerConstants;
...
public class ProductPageController extends AbstractPageController
{
			...
			UnsupportedEncodingException
	{
		...
		list.add(productModel.getBookRating());
		list.add(productModel.getBookCustomerSatisfaction());


		model.addAttribute("attributesList", list);
