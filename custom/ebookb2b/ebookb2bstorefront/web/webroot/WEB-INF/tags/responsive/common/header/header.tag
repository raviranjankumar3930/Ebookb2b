							...
							<c:if test="${empty hideHeaderLinks}">
								...
								<sec:authorize ifNotGranted="ROLE_ANONYMOUS">
                                 ...
                                 <cms:pageSlot position="HeaderLinks" var="link">
                                    ...
                                    <li>
										<ycommerce:testId code="header_ComingSoon">
										<a href="<c:url value="/coming-soon/products"/>" target="_blank">
										<spring:theme code="header.link.ComingSoon" text="Coming Soon"/></a>
										</ycommerce:testId>
									</li>
                                 </cms:pageSlot>
