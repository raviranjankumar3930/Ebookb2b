...
<table class="account-profile-data" border="1">
<tr class="account-orderhistory-table-head responsive-table-head hidden-xs">
						<th><spring:theme code="text.account.profile.column" text="ColumnName"/></th>
	...
	<tr>
		<td><spring:theme code="profile.contactNumber" text="ContactNumber"/>: </td>
		<td>${fn:escapeXml(customerData.contactNumber)}</td>
	</tr>
	<tr>
		<td><spring:theme code="profile.currentLocation" text="currentLocation"/>: </td>
		<td>${fn:escapeXml(customerData.currentLocation)}</td>
	</tr>
	
</table>
<a class="button" href="update-profile"><spring:theme code="text.account.profile.updatePersonalDetails" text="Update personal details"/></a><br/>
<a class="button" href="update-password"><spring:theme code="text.account.profile.changePassword" text="Change password"/></a><br/>
